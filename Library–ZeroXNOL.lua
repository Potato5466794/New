...
local Library do
    ...
    ["Border"] = FromRGB(40, 25, 50),               
    ["Inline"] = FromRGB(35, 20, 45),              
    ["Hovered Element"] = FromRGB(70, 45, 90),      
    ["Page Background"] = FromRGB(20, 12, 25),      
    ["Outline"] = FromRGB(90, 60, 110),             
    ["Element"] = FromRGB(45, 30, 55),             
    ["Gradient"] = FromRGB(140, 100, 180),       
    ["Text"] = FromRGB(230, 220, 240),             
    ["Text Stroke"] = FromRGB(10, 5, 15),           
    ["Placeholder Text"] = FromRGB(120, 100, 140),  
    ["Accent"] = FromRGB(160, 120, 200)            
		}
    }
	...
	Library.Watermark = function(self, Name)
	    ...
	    -- Function to update FPS and MS values
	    local function UpdateWatermark()
	        local fps = math.floor(1 / game:GetService("RunService").RenderStepped:Wait()) -- Basic FPS calculation
	        local ms = math.random(10, 50) -- Placeholder for MS (ping); replace with actual ping logic
	        Items["Text"].Instance.Text = string.format("%s | %d fps | %d ms", Name, fps, ms)
	    end
